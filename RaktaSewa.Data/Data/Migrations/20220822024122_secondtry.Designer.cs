...
namespace RaktaSewa.Data.Migrations
{
    ...
    [Migration("20220822024122_secondtry")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RaktaSewa.Models.Blood", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RaktaSewa.Models.Citizen", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("citizen_id"), 1L, 1);
                    ...
                    b.Property<string>("Citizenship_No")
                        .IsRequired()
                        .HasMaxLength(20)
            ...
            modelBuilder.Entity("RaktaSewa.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RaktaSewa.Models.Seeker", b =>
                {
                    ...
                    b.Property<string>("Amount")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("Seeker_Amount");

                    b.Property<DateTime>("Created_At")
                        .HasColumnType("datetime2")
                        .HasColumnName("Seeker_Created_At");
                    ...
                    b.Property<DateTime?>("Updated_At")
                        .HasColumnType("datetime2")
                        .HasColumnName("Seeker_Updated_At");
            ...
            modelBuilder.Entity("RaktaSewa.Models.Donor", b =>
                {
                    b.HasOne("RaktaSewa.Models.Event", "Events")
                        .WithMany()
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RaktaSewa.Models.Hospital", "Hospitals")
                        .WithMany()
